<div class="main">
	<div class="form">
		...
		<div class="form__main">
			<form action="?option=Login&method=logining" class="main__form active" id="changeForm" method="POST">
			...
			<form action="?option=Login&method=logining" class="main__form" id="changeForm" method="POST">
				<input name="login" class="form__input" placeholder="Введите логин">
				<input name="password" type='password' class="form__input" placeholder="Введите пароль">
